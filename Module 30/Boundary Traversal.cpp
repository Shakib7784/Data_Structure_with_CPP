...
void leftbondary_nonleaves(Tree *root)
{
     if(root == NULL)
    {
        return;
    ...
    {
        cout<<root->data<<" ";
        leftbondary_nonleaves(root->leftchild);

    }
    else if(root->rightchild!=NULL)
    {
         cout<<root->data<<" ";
         leftbondary_nonleaves(root->rightchild );
    }
}
void left_right_leaves(Tree *root)
{
     if(root == NULL)
    {
        return;
    ...
    if(root->leftchild==NULL && root->rightchild==NULL)
    {
     ...
     left_right_leaves(root->leftchild);
    left_right_leaves(root->rightchild);

}

void rightboundary_nonleaves(Tree *root)
{
     if(root == NULL)
    {
        return;
    ...
    {
        cout<<root->data<<" ";
        rightboundary_nonleaves(root->rightchild);
    }
    else if(root->leftchild!=NULL)
    {
        cout<<root->data<<" ";
        rightboundary_nonleaves(root->leftchild);
    }
}


void Boundary_Travers(Tree *root)
{
    if(root == NULL)
    {
        return;
